...
export const showServiceIntro = (title: string, text: string, iconUrl: string) => {
  Swal.fire({
...
export const showDefaultAlert = ( title: string, text: string, iconType: 'success' | 'error' | 'warning' | 'info' | 'question' = "success") => {
  Swal.fire({
...
export const showConfirmAlert = async(title: string, text: string, iconType: 'success' | 'error' | 'warning' | 'info' | 'question' = "warning") => {
